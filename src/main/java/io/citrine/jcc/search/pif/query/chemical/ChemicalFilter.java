 ...
 * @author Kyle Michel
 */
public class ChemicalFilter implements Serializable, HasLogic, HasWeight, HasChemicalFilter {
    ...
    private static final long serialVersionUID = 3084007599825729991L;
